...
| Назад | Вперед |
| --- | --- |
| [Фильтрация последовательности](/Part%202%20-%20Sequence%20Basics/2.%20Reducing%20a%20sequence.md) | [Агрегация](/Part%202%20-%20Sequence%20Basics/4.%20Aggregation.md) |
